...
public class fruitSpecial2 extends Fruit {
    ...
    public fruitSpecial2() {
        ...
        File input1=new File("Magicball1.png");
        try {
        ...
        File input2=new File("Magicball2.png");
        try {
